...
cd C:\SQL2008R2
.\setup.exe /configurationfile="C:\configurationfile.ini" /iacceptsqlserverlicenseterms /sapwd="123456aA" /SQLSVCPASSWORD="123456aA" /AGTSVCPASSWORD="123456aA" /ASSVCPASSWORD="123456aA" /ISSVCPASSWORD="123456aA" /$RSSVCaccount /RSSVCPASSWORD="123456aA"
